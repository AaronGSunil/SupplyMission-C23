...
var bucketBottom,bucketBottomBody;
var bucketLeftBody,bucketRightBody;
var bucketRight,bucketLeft;
...
function draw() {
	...
	if (keyDown(LEFT_ARROW) && packageBody.position.y < 220) {
		var translation= {x:-10,y:0};
		Matter.Body.translate(packageBody,translation);
	}

	if (keyDown(RIGHT_ARROW) && packageBody.position.y < 220) {
		var translation= {x:10,y:0};
		Matter.Body.translate(packageBody,translation);
	}
